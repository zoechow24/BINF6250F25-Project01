...
class DeBruijnGraph():
    ...
    def add_edge(self, left, right):
        ...
        '''
        debrujin_graph[left].append[right]
    ...
    def remove_edge(self, left, right):
        ...
        '''
        debrujin_graph[left].remove[right]
    ...
    def build_debruijn_graph(self, input_string, k):
        ...
        for i in range(len(input_string):
          ...
          left = input_string[i:k-1]  # ABCDE
          right = input_string[i+1:k]  # BCDEF
          add_edge(left, right)
        return debruijn_graph
    ...
    def print_eulerian_walk(self, seed=None):
        ...
        first_node = random.choice(list(debruijn_graph.keys()))
        return eularian_walk(first_node)
    ...
    def eulerian_walk(self, node, seed=None):
        ...
        tour = list(node)
        while debruijn_graph[node] != []:
          edge = random.choice(list(debruijn_graph.values()))  # randomly generate edge from node
